...
import { MARKET_EVAL_LOGGED_OUT_PAGE, MARKET_EVAL_PAGE } from "../../support";

function marketEvalInfoTooltipsFlow(description, beforeFunc) {
...
marketEvalInfoTooltipsFlow(
  "Market Evaluator Info Tooltips (logged out view)",
  () => {
...
marketEvalInfoTooltipsFlow(
  "Market Evaluator Info Tooltips (logged in view)",
  () => {
    cy.login();
