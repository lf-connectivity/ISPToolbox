...
const objectImgIcons: any = {
    [WorkspaceFeatureTypes.COVERAGE_AREA]: `<svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    [WorkspaceFeatureTypes.AP]: `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
