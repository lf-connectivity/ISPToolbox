...
const LOCK_POLYGON_TRUE_ICON = document.createElementNS('http://www.w3.org/2000/svg', 'path');
...
const LOCK_POLYGON_FALSE_ICON = document.createElementNS('http://www.w3.org/2000/svg', 'path');
...
export default class MapboxLockDraggingControl {
    ...
    onAdd(map: mapboxgl.Map): HTMLDivElement {
        ...
        this._svg.setAttribute('viewBox', `0 0 ${DEFAULT_DIMENSIONS} ${DEFAULT_DIMENSIONS}`);
